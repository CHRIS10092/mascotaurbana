...
<center><label style="font-weight: bolder;font-size: 18px;">Numero de empresa: #<?php
echo $_POST['emp_ruc'];
?></label></center>
 <br>
 <label style="font-weight: bolder;font-size: 18px;">Datos Empresa</label><hr style="margin-top: 5px">
