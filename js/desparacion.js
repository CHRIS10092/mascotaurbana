...
const listar_articulos = e => {
	...
	let url = '../controladores/desparacitacion/listar_articulos.php';
	http(url,'POST',null)
	    .then(res => {
...
const registrar_venta = () => {
	...
	let url = '../controladores/desparacitacion/registrar_venta.php';
...
function guardar() {
	...
	$.ajax({
		url:'../controladores/desparacitacion/crear.php' ,
		type:'POST' ,
		data:datosq ,
		contentType: false,
        processData: false,
	...
	.done(function(r) {
		//console.log(r);
		if (r==1) {
			alertify.success("Registro de Vacuna Exitosa");
			setTimeout(function() {
				window.location.href="../app/desparacitacion.php";
			}, 1000);
		}else{
			alertify.error("No se pudo Regisrar la Vacuna");
		}
	})
