...
<div class="col-md-12 col-sm-12 widget-container-col ui-sortable" id="widget-container-col-4">
    <div class="widget-box ui-sortable-handle" id="widget-box-4">
        <div class="widget-header widget-header-large">
            <h4 class="widget-title">Listado de Autorizaciones </h4>
...
<div class="table table-responsive" id="listado-autorizacion"></div>
            </div>
        </div>
    </div>
</div>
...
<script src="../js/historial_autorizacion.js"></script>
<?php } else {
    header("location: ../");
}
?>