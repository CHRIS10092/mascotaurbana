...
<div class="col-md-12 col-sm-12 widget-container-col ui-sortable" id="widget-container-col-4">
    <div class="widget-box ui-sortable-handle" id="widget-box-4">
      ...
      <a href="../procesarpdf/procesararticulos.php" target="_blank">Imprimir PDF</a>
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="txtId" name="id">
                    ...
                    <div class="row">
                        ...
                        <input type="hidden" name="session" value="<?php echo $_SESSION['usuario'][6] ?>">
                    </div>
                </form>
            </div>
...
<script src="../js/historial_articulo.js"></script>
<?php } else {
    header("location: ../");
}
?>