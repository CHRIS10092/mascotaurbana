                ...
                <div class="widget-main">
                    ...
                    <form id="frm-tenedor" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <input type="hidden" id="txt-ten-session" name="ten-session"
                                    value="<?= $_SESSION['empresa']['idempresa']; ?>" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" id="txt-ten-celular" maxlength="10"
                                    placeholder="debe comenzar con 09" name="ten-celular" class="form-control">
                            </div>
                            <div class="col-md-2">
                        ...
                        <h>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" id="txt-ten-calleprincial" name="ten-calleprincial"
                                        class="form-control">
                                </div>
                                <div class="col-md-2">
                                    <label for=""> Numero Casa</label>
                                    <input type="text" id="txt-ten-numerocasa" name="ten-numerocasa"
                                        class="form-control">
                                </div>
                                <div class="col-md-2">
                                    <label for="">Calle Secundaria</label>
                                    <input type="text" id="txt-ten-callesecundaria" name="ten-callesecundaria"
                                        class="form-control">
                                </div>
                                <div class="col-md-2">
                                    <label for="">Refencia Casa</label>
                                    <input type="text" id="txt-ten-referencia" name="ten-referencia"
                                        class="form-control">
                                </div>
                ...
                <div class="widget-main">
                    ...
                    <form id="frm-edit-tenedor" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <input type="hidden" id="txt-sessionu" name="sessionu"
                                    value="<?= $_SESSION['empresa']['idempresa']; ?>" class="form-control">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <label for="">Celular</label>
                                <input type="text" id="txt-celularu" maxlength="10" placeholder="debe comenzar con 09"
                                    name="celularu" class="form-control">
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <label for="">Calle Secundaria</label>
                                <input type="text" id="txt-callesecundariau" name="callesecundariau"
                                    class="form-control">
                            </div>
                            <div class="col-md-2">
                                <label for="">Refencia Casa</label>
