        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                ...
                <div class="alert alert-success alert-dismissible">
                    <center>
                        <h4><i class="icon fa fa-paw"></i> Listar Mascotas</h4>
                    </center>
                </div>
                <div class="pull-left">
            ...
            <div class="modal-body">
                <form id="frm-mascotau" enctype="multipart/form-data">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" id="txt-codigo" name="codigo" readonly="" style="border-radius: 2px;"
                            placeholder="INGRESAR 14 NUMEROS" class="form-control" id="txt-codigo" maxlength="13"
...
<script type="text/javascript" src="../js/editar-mascota.js"></script>