...
class desparacitacion extends config
{
    ...
    public function listar_articulos($id_empresa)
    {
       ...
       SUM(DISTINCT inv_stock) AS stock from tbl_inventarios inv ,tbl_empresas e , inv_tblsubcategoria c WHERE idempresa=:id_empresa
         ...
         AND c.subcategoria='Desparacitacion' GROUP by inv_id";
    ...
    public function insertarDesparacitacion($datos)
    {

        $inv_sql  = "INSERT INTO tbl_desparacitacion(des_descripcion,idmascota,des_fecha,des_fecha_proxima,des_idarticulo) VALUES (?,?,?,?,?)";
