...
class seguros extends config
{
    ...
    public function listar_articulos($id_empresa)
    {
       ...
       SUM(DISTINCT inv_stock) AS stock from tbl_inventarios inv ,tbl_empresas e , inv_tblsubcategoria c WHERE idempresa=:id_empresa
         ...
         AND c.subcategoria='Seguros' GROUP by inv_id";
    ...
    public function insertarSeguro($datos)
    {

        $inv_sql  = "INSERT INTO tbl_seguros_medicos(seg_descripcion,idmascota,seg_fecha,seg_fecha_proxima,seg_idarticulo) VALUES (?,?,?,?,?)";
